            ...
            <ul class="menu-list">
                <li><a href="#" class="pt0">Index <em class="fa fa-chevron-down"></em></a>
                    <ul>
                        ...
                        <li><a href="index-7.html">Index 07</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="#">Property List <em class="fa fa-chevron-down"></em></a>
                            <ul>
                                <li><a href="properties-list-rightside.html">Right Sidebar</a></li>
                                <li><a href="properties-list-leftsidebar.html">Left Sidebar</a></li>
                                <li><a href="properties-list-fullwidth.html">Fullwidth</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">Property Grid <em class="fa fa-chevron-down"></em></a>
                            <ul>
                                <li><a href="properties-list-rightside.html">Right Sidebar</a></li>
                                <li><a href="properties-list-leftsidebar.html">Left Sidebar</a></li>
                                <li><a href="properties-list-fullwidth.html">Fullwidth</a></li>
                        ...
                        <li>
                            <a href="#">Property Map <em class="fa fa-chevron-down"></em></a>
                            <ul>
                                <li><a href="properties-map-rightside-list.html">Map List 01</a></li>
                                <li><a href="properties-map-leftside-list.html">Map List 02</a></li>
                                <li><a href="properties-map-rightside-grid.html">Map Grid 01</a></li>
                                <li><a href="properties-map-leftside-grid.html">Map Grid 02</a></li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="properties-details.html">Property Detail 01</a></li>
                                <li><a href="properties-details-2.html">Property Detail 02</a></li>
                                <li><a href="properties-details-3.html">Property Detail 03</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="agent-grid.html">Agent Grid 01</a></li>
                                <li><a href="agent-grid-2.html">Agent Grid 02</a></li>
                                <li><a href="agent-grid-3.html">Agent Grid 03</a></li>
                            </ul>
                        </li>
                ...
                <li><a href="#">Pages <em class="fa fa-chevron-down"></em></a>
                    <ul>
                        ...
                        <li><a href="search-brand.html">Properties Brands</a></li>
                ...
                <li><a href="#" class="active">My Account <em class="fa fa-chevron-down"></em></a>
                    <ul>
        ...
        <div class="row">
            <div class="dashboard-nav">
                <div class="dashboard-inner">
                    ...
                    <ul>
                      <li><a href="#"><i class="fa fa-briefcase"></i>Portfolio Summary</a></li>

                        <li><a href="#"><i class="fa fa-pie-chart"></i>My Assets</a></li>
                        
                        

                        <li><a href="#"><i class="fa fa-file"></i>Documents </a></li>
                        
                        <li class="active"><a href="#"><i class="fa fa-user"></i>Investor Details </a></li>
 
                        <li><a href="#"><i class="fa fa-user-plus"></i> Linked Payment Account
                        </a></li>
                        
                        <li><a href="#"><i class="fa fa-pie-chart"></i>Open Investment Opportunites </a></li>
 
                        <li><a href="#"><i class="fa fa-area-chart"></i>Upcoming Investment Opportunites </a></li>
                        
                        <li><a href="#"><i class="fa fa-share-alt-square"></i>Referral Status </a></li>
            ...
            <div class="dashboard-content">
                ...
                <div class="submit-address dashboard-list">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Personal Information
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Address Details
                            </button>
                        </li>
                        
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pandetails-tab" data-bs-toggle="tab" data-bs-target="#pandetails" type="button" role="tab" aria-controls="pandetails" aria-selected="false">PAN Details

                            </button>
                        </li>
                        
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="bankdetails-tab" data-bs-toggle="tab" data-bs-target="#bankdetails" type="button" role="tab" aria-controls="bankdetails" aria-selected="false">Bank Details

                            </button>
                        </li>
                        
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nomineedetails-tab" data-bs-toggle="tab" data-bs-target="#nomineedetails" type="button" role="tab" aria-controls="nomineedetails" aria-selected="false">Nominee Details
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row pad-20">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group title">
                                    ...
                                    <input type="text" name="name" class="form-control" id="" placeholder=" Last Name">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="form-group propertytitle">
                                        ...
                                        <input type="text" name="propertytitle" class="form-control" id="" placeholder="Location">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="form-group propertytitle">
                                        ...
                                        <input type="text" name="propertytitle" class="form-control" id="" placeholder="Occupation">
                                            ...
                                            <label class="form-check-label" for="customRadio4">Driving Licence
                                               ...
                                               <div class="row pad-20">
                                                <div class="col-lg-3 col-md-3 col-sm-12">
                                                 ...
                                                 <input type="text" name="DocumentNumber" class="form-control" id="" placeholder="DocumentNumber">
                                    ...
                                    <h4 class="bg-grea-3">Provide your PAN Details below </h4>
                                               <div class="row pad-20">
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                 ...
                                                 <input type="text" name="PANNumber" class="form-control" id="" placeholder="Enter PAN Number" required>
                                                 </div>
                                                 </div>
                                                 ...
                                                 <input type="text" name="PANName" class="form-control" id="" placeholder="Enter Name on PAN Card" required>
                                                 </div>
                                                 </div>
                                                </div>
                                              </form>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <h4 class="bg-grea-3">Provide your Bank Account Details Below </h4>
                                               ...
                                               <div class="row pad-20">
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                 <div class="form-group title">
                                                 <label for="inputacountnumber" class="form-label"> Account Number

                                                 </label>
                                                 <input type="text" name="acountnumber" class="form-control" id="" placeholder="Enter Your Bank A/C Number Here
                                                 " required>
                                                 </div>
                                                 </div>
                                                 ...
                                                 <input type="text" name="ifsccode" class="form-control" id="" placeholder="Enter IFSC Code here
                                                 " required>
                                                 </div>
                                                 </div>
                                                 ...
                                                 <input type="text" name="bankname" class="form-control" id="" placeholder="Enter Your Bank Name Here
                                                 " required>
                                                 </div>
                                                 </div>
                                                </div>
                                      ...
                                      <div class="row pad-20">
                                         ...
                                         <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                           <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="customRadio6">Current Account
                                            ...
                                            <h4 class="bg-grea-3">Upload Cancelled Cheque ( <small>Upload Front Side of the Document
                                            </small> ) </h4>
                                              ...
                                              <form method="GET">
                                               ...
                                               <div class="row pad-20">
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                 ...
                                                 <input type="text" name="acountnumber" class="form-control" id="" placeholder="Enter Your Bank Name
                                                 " required>
                                                 </div>
                                                 </div>
                                                 ...
                                                 <input type="text" name="Card Number" class="form-control" id="" placeholder="xxxxxxx123
                                                 " required>
                                                 </div>
                                                 </div>
                        ...
                        <div class="tab-pane fade" id="nomineedetails" role="tabpanel" aria-labelledby="nomineedetails-tab">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group propertytitle">
                                        ...
                                        <input type="text" name="propertytitle" class="form-control" id="" placeholder="Address">
                                    </div>
                                </div>
                ...
                <p class="sub-banner-2 text-center">© Hissedari.com. Powered by <b><a href="https://design2creative.com/"> Design 2Creative</a></b></p>
            </div>
        </div>
    </div>
</div>
