    ...
    <div class="dashboard-content">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            <div class="form-group address">
                                @isset($user['InvestorData']['user_image'])
                                    <img src="{{ asset('/storage/profile/' . $user['InvestorData']['user_image']) }}"
                                        class="img-fluid" width="80px;" alt="{{ $user['InvestorData']['user_image'] }}">
                                @else
                                    <img src="{{ asset('client-dashboard/img/avatar/man.jpg') }}" class="img-fluid"
                                        width="80px;">
                                @endisset
                            </div>
        ...
        <div class="submit-address dashboard-list">
            ...
            <div class="col-lg-12">
                <div class="heading-properties-2">
                    ...
                    <div class="row mt-4">
                        ...
                        @isset($user['InvestorData']['document_front_image'])
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group address">
                                    <label class="form-label">Document Front Side</label>
                                    <img src="{{ asset('storage/documents/' . $user['InvestorData']['document_front_image']) }}"
                                        width="120">
                                </div>
                        ...
                        @else
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group address">
                                    <label class="form-label">Document dummy Front Side</label>
                                    <img src="{{ asset('client-dashboard/img/pan.png') }}" width="120">
                                </div>

                            </div>
                        @endisset
                        @isset($user['InvestorData']['document_back_image'])
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group address">
                                    <label class="form-label">Document Back Side</label>
                                    <img src="{{ asset('storage/documents/' . $user['InvestorData']['document_back_image']) }}"
                                        width="120">
                                </div>
                        ...
                        @else
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group address">
                                    <label class="form-label">Document dummy Back Side</label>
                                    <img src="{{ asset('client-dashboard/img/pan.png') }}" width="120">
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="heading-properties-2">
                        <div class="row">
                            ...
                            @isset($user['InvestorData']['pan_front_image'])
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="form-group address">
                                        <label class="form-label">Pan Front Side</label>
                                        <img src="{{ asset('storage/pan/' . $user['InvestorData']['pan_front_image']) }}"
                                            width="120">
                                    </div>
                            ...
                            @else
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="form-group address">
                                        <label class="form-label">Pan Dummy Front Side</label>
                                        <img src="{{ asset('client-dashboard/img/pan.png') }}" width="120">
                                    </div>

                                </div>
                            @endisset
                            @isset($user['InvestorData']['pan_back_image'])
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="form-group address">
                                        <label class="form-label">Pan Back Side</label>
                                        <img src="{{ asset('storage/pan/' . $user['InvestorData']['pan_back_image']) }}"
                                            width="120">
                                    </div>
                            ...
                            @else
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="form-group address">
                                        <label class="form-label">Pan Dummy Back Side</label>
                                        <img src="{{ asset('client-dashboard/img/pan.png') }}" width="120">
                                    </div>
                    ...
                    <div class="heading-properties-2">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group address">
                                    <label class="form-label">Full Name</label>
                                    <p><strong>{{ $user->InvestorData['nominee_first_name'] ?? 'NA' }}
                                            {{ $user->InvestorData['nominee_last_name'] ?? '' }}</strong></p>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <a href="{{ url('user/investment-details') }}" class="btn-6 mt-20">Update
                </a>
            </div>
